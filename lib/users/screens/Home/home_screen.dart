          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                theMainSlider(),
                "Flash Sale".text.size(22).bold.make(),
                flashSaleWid(context),
                30.heightBox,
                "Latest Products".text.size(22).bold.make(),
...
Widget flashSaleWid(BuildContext context) {
  var controller = Get.put(HomeController());
  ...
  return SizedBox(
    ...
    child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          Item eachItemData = controller.flashSaleProducts[index];
          var imageAnimation;
          return GestureDetector(
            onTap: () {
              ...
              () => controller.shimmer.value
                  ...
                  : Container(
                      ...
                      margin: EdgeInsets.fromLTRB(
                          index == 0 ? 16 : 8,
                          10,
                          index == controller.latestProduct.length - 1 ? 16 : 8,
                          10),
                      decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(20),
                          color: whiteColor,
